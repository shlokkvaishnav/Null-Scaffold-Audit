...
class TestInformationGeometricBeliefs(unittest.TestCase):
    def test_eta_zero_stationary(self):
        # eta = 0 should completely ignore target and stay rigidly on pi(t)
        igbs = InformationGeometricBeliefState(num_regimes=3, eta=0.0)
    ...
    def test_eta_one_memoryless(self):
        ...
        igbs = InformationGeometricBeliefState(num_regimes=3, eta=1.0)
        igbs.pi = np.array([0.7, 0.2, 0.1])
    ...
    def test_eta_half_geometric_mean_interpolation(self):
        ...
        igbs = InformationGeometricBeliefState(num_regimes=2, eta=0.5)
    ...
    def test_sum_to_one_simplex_bounds_preservation(self):
        ...
        igbs = InformationGeometricBeliefState(num_regimes=4, eta=0.33)
