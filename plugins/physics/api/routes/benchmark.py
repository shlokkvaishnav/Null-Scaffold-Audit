...
CLI:
    ...
    python -m plugins.physics.benchmark_runner --subset all
"""
...
from plugins.physics.benchmark_runner import run_benchmark
    ...
    if subset != "smoke":
        raise HTTPException(
            ...
            detail=(
                ...
                "Run 'python -m plugins.physics.benchmark_runner --subset all' "
