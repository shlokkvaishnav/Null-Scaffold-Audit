...
def download_data(output_dir: Path):
    ...
    if resume_byte_pos > 0:
        ...
        mode = "ab"
        logger.info(f"🔄 Resuming download from {resume_byte_pos / (1024**3):.2f} GB...")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="data/01_raw", help="Directory to save data")
