...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default=".", help="Base project directory")
    parser.add_argument("--config", type=str, default="configs/pysr_config.yaml", help="Path to PySR config")
    parser.add_argument("--sample_size", type=int, default=25000, help="Number of samples to use")
    ...
    try:
        ...
        logger.error("Processed data not found. Run scripts/run_preprocessing.py first.")
        return
